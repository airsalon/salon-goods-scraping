...
object Main extends App {
  ...
  val loginResult = browser.post("http://www.club-y.info/yindex.php", loginForm)
   ...
   */
  def write(browser: Browser, writer: CSVWriter, maker: String, page: Int): Unit = {
